...
import { PersonalBottomNavbar } from "@/components/personal-bottom-navbar";
...
export default function PersonalLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="flex items-center justify-between p-4 bg-white shadow-md sticky top-0 z-40">
        <Link href="/personal" className="flex items-center space-x-2">
            ...
            <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                        <p className="text-sm font-medium leading-none">{user?.displayName || "Personal"}</p>
