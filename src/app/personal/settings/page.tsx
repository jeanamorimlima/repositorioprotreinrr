...
import { ChevronRight, CreditCard, Bell, Shield, User, Link as LinkIcon, LogOut, FileText } from 'lucide-react';
import Link from 'next/link';
import { Button } from '@/components/ui/button';

const settingsGroups = [
    {
        title: 'Conta e Ferramentas',
        options: [
            {
            ...
            {
                href: '/personal/assessments',
                icon: FileText,
                title: 'Modelos de Avaliação',
                description: 'Crie e gerencie os modelos de avaliação para seus alunos.'
            },
            {
                href: '/personal/settings/subscription',
                icon: CreditCard,
                title: 'Assinatura',
                description: 'Gerencie seu plano, pagamentos e faturas.'
            },
            {
                href: '/personal/settings/payment-methods',
                icon: CreditCard,
    ...
    },
    {
        ...
        options: [
            ...
            {
                href: '/personal/settings/security',
                icon: Shield,
