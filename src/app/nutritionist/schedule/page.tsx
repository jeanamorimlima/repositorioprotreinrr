...
import { Clock, Plus, Video, Utensils } from 'lucide-react';

const mockEvents = {
    '2024-08-15': [
        { time: '10:00', title: 'Consulta Inicial - Juliana Mendes', type: 'consultation' },
        { time: '11:00', title: 'Retorno - Ricardo Alves', type: 'consultation' },
    ],
    '2024-08-21': [
        { time: '14:00', title: 'Reunião Online - Novo Paciente', type: 'consultation' },
    ]
};
