...
const mockRanking = Array.from({ length: 100 }, (_, i) => ({
    ...
    // Garante que existam 50 de cada tipo
    type: i < 50 ? 'Personal Trainer' : 'Nutricionista',
...
const hallOfFame = {
    "Julho 2024": mockRanking.slice(0, 10).map(p => ({...p, points: p.points + Math.floor(Math.random() * 100) - 50})),
    "Junho 2024": mockRanking.slice(0, 10).map(p => ({...p, points: p.points + Math.floor(Math.random() * 200) - 100})).sort((a,b) => b.points - a.points),
};
...
export default function RankingPage() {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            ...
            <Tabs defaultValue="nutritionists" className="w-full max-w-4xl mx-auto">
