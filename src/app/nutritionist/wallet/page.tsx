...
const mockTransactions = [
    { id: 'txn_nutri_1', date: '2024-08-02', description: 'Venda - Plano Alimentar de Verão', patientName: 'Juliana Mendes', type: 'sale', amount: 99.90 },
    { id: 'txn_nutri_2', date: '2024-07-28', description: 'Venda - Consulta Avulsa', patientName: 'Ricardo Alves', type: 'sale', amount: 250.00 },
    { id: 'txn_nutri_3', date: '2024-07-22', description: 'Saque para conta bancária', patientName: '', type: 'payout', amount: -300.00 },
    { id: 'txn_nutri_4', date: '2024-07-18', description: 'Venda - E-book Lanches Saudáveis', patientName: 'Carlos Andrade', type: 'sale', amount: 29.90 },
];

const mockBalance = {
    available: 49.80,
    totalRevenueAllTime: 850.50,
};
                                ...
                                {filteredTransactions.map((t) => (
                                    <TableRow key={t.id}>
                                        ...
                                        <TableCell>
                                            ...
                                            {t.patientName && <p className="text-xs text-muted-foreground">{t.patientName}</p>}
                                        </TableCell>
                                        <TableCell>
